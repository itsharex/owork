...
[✨ Features](#features) • [🚀 Quick Start](./QUICK_START_EN.md) • [🖥️ Desktop App](#desktop-application-owork) • [🛡️ Security](#security) • [📚 Documentation](#documentation)
...
1. Download [`Owork_x.x.x_aarch64.dmg`](https://d1a1de1i2hajk1.cloudfront.net/owork/release/v0.0.89/Owork_0.0.89_aarch64.dmg)
...
1. Download [`Owork_x.x.x._x64-setup.zip`](https://d1a1de1i2hajk1.cloudfront.net/owork/release/v0.0.89/Owork_0.0.89_x64-setup.zip)
